...
type t =
  ...
  | Reserved_0 (** Reserved. The specific meaning might be defined in the future. *)
  | No_status_code
  ...
  (** 1006 is a reserved value and MUST NOT be set as a status code in a Close control
      frame by an endpoint. It is designated for use in applications expecting a status
      code to indicate that the connection was closed abnormally, e.g., without sending or
  ...
  (** 1008 indicates that an endpoint is terminating the connection because it has
      ...
      be returned when there is no other more suitable status code (e.g., 1003 or 1009) or
